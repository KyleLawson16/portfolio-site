		...
		return (
			<div>
				<div className="name__container">
					<img className="name__img" src={Name} alt="KyleLawson" />
				</div>
				...
				<Layout className="body__container">
					<div className="project-board__container">
						...
						<div className="project-board__text">
							<h1 className="thumbnail__title thumbnail__project-header">
								My Projects
							</h1>
							{this.renderThumbnails()}
							<h1 className="thumbnail__title thumbnail__click-me">
								"click me"
							</h1>
						</div>
					</div>
					<div>
						<img src={Background} className="desk-photo" alt="desk" />
					</div>
					<button
						className="btn__learn-more"
						style={{
							top:
								0.173 * this.props.windowHeight + 0.347 * this.props.windowWidth
						}}
            ...
            <img src={Iphone1} className="iphone__image" />
          </div> */}
					...
					<Modal
						...
						maskClosable={true}
						closable={false}>
						<div onClick={this.closeModal} className="modal__container">
                  ...
                  s0.2,0,0.3-0.1c0.2-0.2,0.2-0.5,0-0.7L13.2,12.5z"
						...
						<div onClick={this.nextProject} className="modal__container">
							<div className="modal__arrow">
								<svg
									...
									viewBox="0 0 36 18"
									style={{
										enableBackground: 'new 0 0 36 18',
										color: '#b3b3b3'
									}}>
									<path
                  ...
                  l-7.8,7.7c-0.2,0.2-0.2,0.5,0,0.7c0.1,0.1,0.2,0.1,0.3,0.1s0.3,0,0.3-0.1L36,9L27.1,0.1z"
						...
						<div onClick={this.previousProject} className="modal__container">
							<div className="modal__arrow modal__arrow--left">
								<svg
									version="1.1"
									id="Layer_1"
									xmlns="http://www.w3.org/2000/svg"
                  ...
                  l-7.8,7.7c-0.2,0.2-0.2,0.5,0,0.7c0.1,0.1,0.2,0.1,0.3,0.1s0.3,0,0.3-0.1L36,9L27.1,0.1z"
						...
						<img
							src={this.state.activeProject.modal.image}
